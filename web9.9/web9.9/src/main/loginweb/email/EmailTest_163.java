...
public class EmailTest_163 {
    // 发件人 账号和密码
    public static final String MY_EMAIL_ACCOUNT = "lizihengxdf@163.com";
    public static final String MY_EMAIL_PASSWORD = "PWTYLTCOHIWIXSGE"; // 密码,是你自己的设置的授权码
    ...
    // 收件人
    public static final String RECEIVE_EMAIL_ACCOUNT = "1065077632@qq.com";
